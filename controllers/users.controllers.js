...
module.exports = {
	...
	register: async (req, res, next) => {
		try {
			...
			let PictDefault = "https://ik.imagekit.io/amarafiif/default-user-pict.jpg?updatedAt=1717927033171";
			...
			//set token for otp
			let token = jwt.sign({ account_id: user.account_id, email: user.email }, JWT_SECRET_KEY);
